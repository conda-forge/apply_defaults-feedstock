...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/apply_defaults-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7816&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/apply_defaults-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `apply_defaults` can be installed with:

```
conda install apply_defaults
```

It is possible to list all of the versions of `apply_defaults` available on your platform with:
